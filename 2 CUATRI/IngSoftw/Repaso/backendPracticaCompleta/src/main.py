...
from api import users, movies, auth, inference
...
# Separamos los ENDPOINTS en :
app.include_router(users.router) # users.py
app.include_router(movies.router) # movies.py
app.include_router(auth.router) # auth.py
app.include_router(inference.router) # inference.py
