...
################################ PARAMETROS ###############################################
kR_lineal = np.linspace(0.700, 0.800, 3) # [0.700, 0.750, 0.800] 
kR_angular = np.linspace(0.055, 0.065, 3)  # [0.055, 0.060, 0.065]
retrasoR =  np.linspace(1.45, 1.55, 3) # [1.45, 1.50, 1.55]

kT_lineal = np.linspace(0.950, 1.050, 3) # [0.950, 1.000, 1.050]
kT_angular = np.linspace(0.015, 0.025, 3) # [0.015, 0.020, 0.025]
retrasoT = np.linspace(0.90, 1.10, 3) # [0.90, 1.00, 1.10]
